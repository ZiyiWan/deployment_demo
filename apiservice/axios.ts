...
//test
export function getPatientsByName(name: string) {
  const result: any = axios
    .get(
      `https://hapi.fhir.org/baseR4/Patient?_sort=_id&name=${name}&_count=10&_format=json&_pretty=true&_bundletype=searchset`
